...
async def direct_join_team(teamcode, max_retries=3, timeout=5):
    ...
    try:
        from SulavGaming import online_writer, key, iv, team_collection_active
...
async def direct_send_emote(uid, emote_code, max_retries=2):
    ...
    try:
        from SulavGaming import online_writer, key, iv, region, team_collection_active
...
async def direct_leave_team():
    ...
    try:
        from SulavGaming import online_writer, key, iv
            ...
            function renderEmotes() {
                ...
                displayedEmotes.forEach(emote => {
                    ...
                    const sourceBadge = emote.source === 'local' 
                        ? '<div class="emote-source-badge source-local">SulavGaming</div>'
...
def api_debug_status():
    ...
    try:
        from SulavGaming import team_collection_active, team_members_data, online_writer
...
if __name__ == '__main__':
    ...
    try:
        ...
        from SulavGaming import StarTinG
